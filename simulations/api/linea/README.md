...
[**Source code**](./asset-balance-changes.mjs)

To run the script:

```bash
TENDERLY_ACCOUNT_ID=??? TENDERLY_PROJECT=??? TENDERLY_ACCESS_KEY=??? \
node asset-balance-changes.mjs
```
...
[**Source code**](./state-overrides.mjs)

To run the script:

```bash
TENDERLY_ACCOUNT_ID=??? TENDERLY_PROJECT=??? TENDERLY_ACCESS_KEY=??? \
node state-overrides.mjs
```
...
[**Generating access list**](./access-list.mjs)

To run the script:

```bash
TENDERLY_ACCOUNT_ID=??? TENDERLY_PROJECT=??? TENDERLY_ACCESS_KEY=??? \
node access-list.mjs
```
...
[**Source code**](./state-changes.mjs)

To run the script:

```bash
TENDERLY_ACCOUNT_ID=??? TENDERLY_PROJECT=??? TENDERLY_ACCESS_KEY=??? \
node state-changes.mjs
```
...
[**Source code**](./decoded-events.mjs)

To run the script:

```bash
TENDERLY_ACCOUNT_ID=??? TENDERLY_PROJECT=??? TENDERLY_ACCESS_KEY=??? \
node decoded-events.mjs
```
